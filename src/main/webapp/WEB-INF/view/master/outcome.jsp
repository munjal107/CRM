                    ...
                    <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            ...
                            <li class="m-nav__item"><a href="" class="m-nav__link">
                                    <span class="m-nav__link-text">Add Outcome</span>
                            </a></li>--%>
                        </ul>
                    </div>
                ...
                <div class="m-portlet m-portlet--tab">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text ">Add Outcome</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                                data-target="#m_modal_5">Add Category
                        </button>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            ...
                            <c:forEach var="slist" items="${alist}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<%=request.getContextPath()%>/master/deleteOutcome?id=${slist.id}">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/master/addOutcome" id="outcome">
                                <div class="form-group">
                                    <label for="recipient-name" class="form-control-label">Outcome Name:</label>
            ...
            <div class="modal fade" id="m_modal_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/master/editOutcome" id="editoutcome">
                                <div class="form-group">
            ...
            fields: {
                name: {
                    validators: {
                        ...
                        regexp: {
                            regexp: /^[a-zA-Z\s]+$/i,
                            message: 'Outcome can consist of alphabetical characters and spaces only'
                        }
                    }
                }
