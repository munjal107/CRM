                    ...
                    <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            ...
                            <li class="m-nav__item"><a href="" class="m-nav__link">
                                    <span class="m-nav__link-text">Add UserRole</span>
                            </a></li>--%>
                        </ul>
                    </div>
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                                data-target="#m_modal_5">Add Role
                        </button>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            ...
                            <c:forEach var="slist" items="${alist}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<%=request.getContextPath()%>/master/deleteRole?id=${slist.id}">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/master/addRole" id="addrole">
            ...
            <div class="modal fade" id="m_modal_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/master/editRole" id="editrole">
                                <div class="form-group">
                                    <label for="recipient-name" class="form-control-label">Role Name:</label>
