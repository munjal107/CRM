                    ...
                    <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            ...
                            <li class="m-nav__item"><a href="" class="m-nav__link">
                                    <span class="m-nav__link-text">Add Business Catagory</span>
                            </a></li>--%>
                        </ul>
                    </div>
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text ">Add Business Category</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            ...
                            <c:forEach var="slist" items="${alist}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<%=request.getContextPath()%>/master/deleteCategory?id=${slist.id}">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/master/addCategory" id=businesscategory>
            ...
            <div class="modal fade" id="m_modal_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/master/editCategory" id="editbusinesscategory">
                                <div class="form-group">
                                    <label for="recipient-name" class="form-control-label">Category Name:</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#businesscategory").formValidation({
            framework: 'bootstrap',
            excluded: ":disabled",
            icon: null,
            fields: {
        ...
        $("#editbusinesscategory").formValidation({
            framework: 'bootstrap',
            excluded: ":disabled",
            icon: null,
            fields: {
