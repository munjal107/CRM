            ...
            <div class="m-content">
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    <form class="m-form m-form--fit m-form--label-align-left"
                          method="post" enctype="multipart/form-data" action="/enquiry/addLead" id="editlead">

                        <input type="hidden" value="${leadObj.id}" name="id">
                                ...
                                <tr>
                                    <td width="50%">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air m-select2"
                                                    ...
                                                    <option value="${leadObj.ls.id }"
                                                            selected="selected"> ${leadObj.ls.sourceName }</option>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control m-input" type="text" id="example-text-input"
                                                       name="corporateName" placeholder="Corporate name"
                                                       value="${leadObj.corporateName}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air"
                                                    ...
                                                    <option value="${leadObj.bs.id}"
                                                            selected="selected">${leadObj.bs.name}</option>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air"
                                                    ...
                                                    <option value="${leadObj.noOfEmployees}">Select Employees</option>
                                                    <option>Self</option>
                                                    <option>1-10</option>
                                                    <option>11-50</option>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air"
                                                        id="turnoverSelect" name="turnover">
                                                    <option value="${leadObj.turnover}">${leadObj.turnover}</option>
                                                    <option>1</option>
                                                    <option>2</option>
                                                    <option>3</option>
                                                    <option>4</option>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air"
                                                    ...
                                                    <option value="${leadObj.packages}" disabled selected>---Select
                                                        Package---
                                                    </option>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
													<textarea class="form-control m-input m-input--air"
                                                              ...
                                                              name="remarks">${leadObj.remarks }</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control m-input" type="text"
                                                       ...
                                                       name="address" value="${leadObj.address}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air"
                                                    ...
                                                    <option value="${leadObj.country.countryName} }"></option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air"
                                                    ...
                                                    <option value="${leadObj.state.stateName} }"></option>
                                                </select>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control m-input m-input--air"
                                                    ...
                                                    <option value="${leadObj.city.cityName} }">select city</option>
                    ...
                    fields: {
                        ...
                        remarks: {
                            validators: {
                                ...
                                stringLength: {
                                    max: 20,
                                    message: 'Remarks must be less than 20 characters'
                                }
                            }
                        },
