    ...
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
                    ...
                    <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            ...
                            <li class="m-nav__item">
                                <a href="/estimate/view" class="m-nav__link">
            ...
            <div class="m-content">
                ...
                <!--begin::Form-->
                <form class="m-form m-form--fit m-form--label-align-right" method="post" action="/estimate/addEstimate"
                      id="invoice">
                    <!--begin::Portlet-->
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="50%" style="vertical-align:top">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-3 col-form-label">Estimate
                                                No.</label>
                                            <div class="col-9">
                                                <input class="form-control m-input" type="number" name="estimateNo"
                                                       id="example-text-input" value="${estimateNo}"
...
// 					}));
        ...
        $("#CorporateName").change(
            function () {
                $.get("/enquiry/getLeads/" + $('#CorporateName').val(), function (data, status) {
                    ...
                    $("#invoice").formValidation('revalidateField', 'customerName');
                    $("#invoice").formValidation('revalidateField', 'mobileno');
                });
            });
