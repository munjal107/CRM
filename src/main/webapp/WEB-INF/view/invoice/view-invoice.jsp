                ...
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            ...
                            <li class="m-nav__item"><a href="/invoice/new" class="m-nav__link">
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">Invoice</h3>
                            </div>
                        </div>
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                <li class="m-portlet__nav-item"><a href="/invoice/new"
                                                                   class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
											<span> <i class="fa fa-wallet"></i> <span>Generate Invoice</span>
										</span>
                                </a></li>
                            </ul>
                        </div>
                            ...
                            [
                                {
                                    ...
                                    render: function (a, t, e, n) {
                                        return '<a href="/invoice/print-invoice/' + e.invoiceNo + '" target="_blank" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Print Innovice">\n                          <i class="fa fa-print"></i>\n                        </a> \n\n<a href="/invoice/viewInvoice/' + e.id + '" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Generate Innovice">\n                          <i class="fa fa-wallet"></i>\n                        </a> '
                                    }
                                }, {
                                targets: 6,
                                title: "Product Name",
