                                            ...
                                            <div class="m-invoice__container m-invoice__container--centered">
                                                ...
                                                <div class="m-invoice__items">
                                                    ...
                                                    <div class="m-invoice__item">
                                                        ...
                                                        <span class="m-invoice__text">IN - ${iData.invoiceNo }</span>
                                                    </div>
                                                    <div class="m-invoice__item">
                                                    ...
                                                    <div class="m-invoice__item">
                                                        <span class="m-invoice__subtitle">GST Type</span>
                                                        <span class="m-invoice__text">${iData.GSTtype }</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="m--font-danger">
                                                                ...
                                                                <fmt:formatNumber type="number" maxFractionDigits="2"
                                                                    ...
                                                                    <%-- <c:set var = "total" value = "${alist[string2]+ alist[string2] * alist.tax /100}" />
                                                                ${total } --%>
                                                            </td>
                                                        </tr>
                            ...
                            <div class="m-portlet__body m-portlet__body--no-padding"
                                ...
                                <div class="col-mg-5">
                                    ...
                                    <span style="text-align:right;float:right;margin-bottom:15px;">
											<a target="_blank" href="/invoice/print-invoice/${iData.invoiceNo}">
